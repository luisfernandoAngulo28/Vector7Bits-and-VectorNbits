...
public class Vector7Bits {
   ...
   int cantidad;
   //constructor           //10
   public Vector7Bits(int numeroElementos){
       int Numerobits=numeroElementos*7;//70
   ...
   public void insertar(int elemento,int posicion){
       if (posicion<=cantidad) {
           ...
           V[NumeroEntero]=V[NumeroEntero]|elemento;
            ...
            if ((NumeroBits+7)>32) {
              int mask1=(int) (Math.pow(2, 7)-1);//127
